        ...
        <Card className="max-w-2xl w-full p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6 text-left">
            ...
            <div className="flex justify-between pt-3 border-t">
              <span className="text-gray-600">TimeHold Amount</span>
          ...
          <Card className="p-8">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-6">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-purple-900 mb-2">How TimeHold Works</h3>
            ...
            <div className="border rounded-lg p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-purple-600">
                  <span className="font-medium">TimeHold Amount</span>
                  <span className="text-lg font-bold">€{service?.timehold}</span>
                </div>
                <p className="text-xs text-gray-500 pt-2">
                  Full payment of €{service?.price} due at appointment. TimeHold released when you arrive.
                </p>
              </div>
            </div>
              ...
              {!selectedService ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="flex justify-between text-purple-600">
                      <span className="font-medium">TimeHold</span>
                  ...
                  <div className="bg-purple-50 rounded-lg p-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-xs text-purple-700">
                        Only TimeHold amount will be authorized. Released when you arrive.
                      </p>
                    </div>
                  </div>
                  <Button
